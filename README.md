...
> 따라서, 큰 사고로 이어질 수 있는 졸음운전을 운전자의 눈감는 시간을 AI가 자동적으로 파악하여, 스피커의 청각적 경고와 LED의 시각적 경고를 활용해서 졸음운전을 예방하고자 제작하게 되었다. 
...
- **모델 선택 이유**: 모델에 눈 주위에 눈의 모양을 나타내는 점(랜드마크)이 있다. 이 점으로 감긴 눈의 크기를 측정하기가 쉽고 눈 크기 계산이 빠르다.또한, 다수의 데이터 사전 학습 없이도 프로그램 실행이 가능하다.
...
| 인식 화면 | 아두이노 동작 |
|-----------|--------------|
| ![화면 Ready 상태](scr_rdy.png) | ![아두이노 Ready 상태](adu_rdy.jpg) |
| ![화면 Alert 상태](scr_alt.png) | ![아두이노 Alert 상태](adu_alt.jpg) |
| ![화면 Emergency 상태](scr_emg.png) | ![아두이노 Emergency 상태](adu_emg.jpg) |
